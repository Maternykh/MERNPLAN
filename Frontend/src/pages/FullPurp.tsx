...
const FullPurp: React.FC = () => {
  ...
  return (
    <div className="xl:w-1/4 w-full">
      <div className=" bg-white rounded-xl p-2 mb-1">
      ...
      <div className=" flex">
        <Link
          to={`/putPurps/${_id}`}
          onClick={() => setPutPurp()}
          className=" hover:cursor-pointer mr-1 text-xl bg-white p-2 rounded-xl text-orange-500"
        >
          <BiPencil />
        </Link>
        <div
          onClick={() => Delete()}
          className=" hover:cursor-pointer text-xl bg-white p-2 rounded-xl text-red-500"
        >
          <IoMdTrash />
        </div>
      </div>
